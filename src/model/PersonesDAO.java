...
public class PersonesDAO {
	...
	public List<Persona> getPersonesList() {
		...
		try (ResultSet result = con.createStatement().executeQuery("SELECT * FROM persones")) {
			while (result.next()) {
	...
	public Persona find(Integer id){
		...
		Persona p = null;
		try (PreparedStatement stmt = con.prepareStatement("SELECT * FROM persones WHERE id = ?")){
